...
# Generated by qmake (2.01a) (Qt 4.7.1) on: Thu Mar 24 13:23:53 2011
...
CC            = gcc
CXX           = g++
DEFINES       = -DAPP_VERSION=\"0.5.1\" -DQT_NO_DEBUG -DQT_SQL_LIB -DQT_XML_LIB -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
...
SOURCES       = main.cpp \
		...
		qjson/json_parser.cc moc_MainWindow.cpp \
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/entomologist0.5.1 || $(MKDIR) .tmp/entomologist0.5.1 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/entomologist0.5.1/ && $(COPY_FILE) --parents MainWindow.h libmaia/maiaXmlRpcServerConnection.h libmaia/maiaXmlRpcServer.h libmaia/maiaXmlRpcClient.h libmaia/maiaObject.h libmaia/maiaFault.h trackers/Backend.h trackers/Bugzilla.h NewTracker.h trackers/NovellBugzilla.h Autodetector.h SqlBugModel.h SqlBugDelegate.h CommentFrame.h UploadDialog.h Preferences.h About.h SqlWriterThread.h SqlWriter.h PlaceholderLineEdit.h qtsoap/qtsoap.h trackers/Mantis.h ChangelogWindow.h ChangelogListDelegate.h trackers/Launchpad.h qjson/qjson_debug.h qjson/position.hh qjson/parserrunnable.h qjson/parser_p.h qjson/parser.h qjson/location.hh qjson/json_scanner.h qjson/json_parser.hh qjson/stack.hh qjson/serializerrunnable.h qjson/serializer.h qjson/qobjecthelper.h qjson/qjson_export.h .tmp/entomologist0.5.1/ && $(COPY_FILE) --parents resources.qrc .tmp/entomologist0.5.1/ && $(COPY_FILE) --parents main.cpp MainWindow.cpp libmaia/maiaXmlRpcServerConnection.cpp libmaia/maiaXmlRpcServer.cpp libmaia/maiaXmlRpcClient.cpp libmaia/maiaObject.cpp libmaia/maiaFault.cpp trackers/Backend.cpp trackers/Bugzilla.cpp NewTracker.cpp trackers/NovellBugzilla.cpp Autodetector.cpp SqlBugModel.cpp SqlBugDelegate.cpp CommentFrame.cpp UploadDialog.cpp Preferences.cpp About.cpp SqlWriterThread.cpp SqlWriter.cpp PlaceholderLineEdit.cpp qtsoap/qtsoap.cpp trackers/Mantis.cpp ChangelogWindow.cpp ChangelogListDelegate.cpp trackers/Launchpad.cpp qjson/parserrunnable.cpp qjson/parser.cpp qjson/json_scanner.cpp qjson/serializerrunnable.cpp qjson/serializer.cpp qjson/qobjecthelper.cpp qjson/json_parser.cc .tmp/entomologist0.5.1/ && $(COPY_FILE) --parents MainWindow.ui NewTracker.ui CommentFrame.ui UploadDialog.ui Preferences.ui About.ui ChangelogWindow.ui .tmp/entomologist0.5.1/ && $(COPY_FILE) --parents entomologist_en.ts .tmp/entomologist0.5.1/ && (cd `dirname .tmp/entomologist0.5.1` && $(TAR) entomologist0.5.1.tar entomologist0.5.1 && $(COMPRESS) entomologist0.5.1.tar) && $(MOVE) `dirname .tmp/entomologist0.5.1`/entomologist0.5.1.tar.gz . && $(DEL_FILE) -r .tmp/entomologist0.5.1
...
distfile:
	mkdir -p .tmp/entomologist-0.5.1 && cp -r -f --parent main.cpp MainWindow.cpp libmaia/maiaXmlRpcServerConnection.cpp libmaia/maiaXmlRpcServer.cpp libmaia/maiaXmlRpcClient.cpp libmaia/maiaObject.cpp libmaia/maiaFault.cpp trackers/Backend.cpp trackers/Bugzilla.cpp NewTracker.cpp trackers/NovellBugzilla.cpp Autodetector.cpp SqlBugModel.cpp SqlBugDelegate.cpp CommentFrame.cpp UploadDialog.cpp Preferences.cpp About.cpp SqlWriterThread.cpp SqlWriter.cpp PlaceholderLineEdit.cpp qtsoap/qtsoap.cpp trackers/Mantis.cpp ChangelogWindow.cpp ChangelogListDelegate.cpp trackers/Launchpad.cpp qjson/parserrunnable.cpp qjson/parser.cpp qjson/json_scanner.cpp qjson/serializerrunnable.cpp qjson/serializer.cpp qjson/qobjecthelper.cpp qjson/json_parser.cc MainWindow.h libmaia/maiaXmlRpcServerConnection.h libmaia/maiaXmlRpcServer.h libmaia/maiaXmlRpcClient.h libmaia/maiaObject.h libmaia/maiaFault.h trackers/Backend.h trackers/Bugzilla.h NewTracker.h trackers/NovellBugzilla.h Autodetector.h SqlBugModel.h SqlBugDelegate.h CommentFrame.h UploadDialog.h Preferences.h About.h SqlWriterThread.h SqlWriter.h PlaceholderLineEdit.h qtsoap/qtsoap.h trackers/Mantis.h ChangelogWindow.h ChangelogListDelegate.h trackers/Launchpad.h qjson/qjson_debug.h qjson/position.hh qjson/parserrunnable.h qjson/parser_p.h qjson/parser.h qjson/location.hh qjson/json_scanner.h qjson/json_parser.hh qjson/stack.hh qjson/serializerrunnable.h qjson/serializer.h qjson/qobjecthelper.h qjson/qjson_export.h MainWindow.ui NewTracker.ui CommentFrame.ui UploadDialog.ui Preferences.ui About.ui ChangelogWindow.ui resources.qrc COPYING Entomologist.pro README INSTALL *.qm *.ts entomologist.desktop entomologist.spec graphics/ install_icons/ libmaia/ .tmp/entomologist-0.5.1 && cd .tmp && tar cvzf entomologist-0.5.1\.tar.gz entomologist-0.5.1 && mv entomologist-0.5.1\.tar.gz .. && cd ..
...
moc_parserrunnable.cpp: qjson/qjson_export.h \
	...
	/usr/bin/moc $(DEFINES) $(INCPATH) qjson/parserrunnable.h -o moc_parserrunnable.cpp

moc_serializerrunnable.cpp: qjson/qjson_export.h \
		qjson/serializerrunnable.h
	/usr/bin/moc $(DEFINES) $(INCPATH) qjson/serializerrunnable.h -o moc_serializerrunnable.cpp
...
Launchpad.o: trackers/Launchpad.cpp qjson/parser.h \
