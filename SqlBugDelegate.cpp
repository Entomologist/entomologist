...
// To indicate changed fields in bug reports, we use <font color="red">
// around the values in the shadow_bug table.  This renders the HTML into
// the bug cell.
void
SqlBugDelegate::paint(QPainter *painter,
