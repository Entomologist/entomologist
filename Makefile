...
# Generated by qmake (2.01a) (Qt 4.6.3) on: Sun Feb 20 11:10:37 2011
...
CC            = gcc
CXX           = g++
DEFINES       = -DAPP_VERSION=\"0.1\" -DQXT_GUI_LIB -DQXT_CORE_LIB -DQT_NO_DEBUG -DQT_SQL_LIB -DQT_XML_LIB -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
...
INCPATH       = -I/usr/share/qt4/mkspecs/default -I. -I/usr/include/QtCore -I/usr/include/QtNetwork -I/usr/include/QtGui -I/usr/include/QtXml -I/usr/include/QtSql -I/usr/include -I/usr/include/QxtCore -I/usr/include/QxtGui -I/usr/local/Qxt/include -I/usr/local/Qxt/include/QxtGui -I/usr/local/Qxt/include/QxtCore -I. -I.
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib64 -Wl,-rpath,/usr/local/Qxt/lib -L/usr/local/Qxt/lib -lQxtGui -lQxtCore -lQtSql -L/usr/lib64 -lQtXml -lQtGui -L/usr/X11R6/lib64 -lQtNetwork -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
SOURCES       = main.cpp \
		...
		About.cpp \
		SqlWriterThread.cpp \
		SqlWriter.cpp moc_MainWindow.cpp \
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/Entomologist0.1 || $(MKDIR) .tmp/Entomologist0.1 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Entomologist0.1/ && $(COPY_FILE) --parents MainWindow.h libmaia/maiaXmlRpcServerConnection.h libmaia/maiaXmlRpcServer.h libmaia/maiaXmlRpcClient.h libmaia/maiaObject.h libmaia/maiaFault.h Backend.h Bugzilla.h NewTracker.h NovellBugzilla.h Autodetector.h SqlBugModel.h SqlBugDelegate.h CommentFrame.h UploadDialog.h Preferences.h About.h SqlWriterThread.h SqlWriter.h .tmp/Entomologist0.1/ && $(COPY_FILE) --parents resources.qrc .tmp/Entomologist0.1/ && $(COPY_FILE) --parents main.cpp MainWindow.cpp libmaia/maiaXmlRpcServerConnection.cpp libmaia/maiaXmlRpcServer.cpp libmaia/maiaXmlRpcClient.cpp libmaia/maiaObject.cpp libmaia/maiaFault.cpp Backend.cpp Bugzilla.cpp NewTracker.cpp NovellBugzilla.cpp Autodetector.cpp SqlBugModel.cpp SqlBugDelegate.cpp CommentFrame.cpp UploadDialog.cpp Preferences.cpp About.cpp SqlWriterThread.cpp SqlWriter.cpp .tmp/Entomologist0.1/ && $(COPY_FILE) --parents MainWindow.ui NewTracker.ui CommentFrame.ui UploadDialog.ui Preferences.ui About.ui .tmp/Entomologist0.1/ && $(COPY_FILE) --parents entomologist_en.ts .tmp/Entomologist0.1/ && (cd `dirname .tmp/Entomologist0.1` && $(TAR) Entomologist0.1.tar Entomologist0.1 && $(COMPRESS) Entomologist0.1.tar) && $(MOVE) `dirname .tmp/Entomologist0.1`/Entomologist0.1.tar.gz . && $(DEL_FILE) -r .tmp/Entomologist0.1
...
ui_MainWindow.h: MainWindow.ui \
		/usr/local/Qxt/include/QxtGui/QxtLineEdit \
		/usr/local/Qxt/include/QxtGui/QxtCheckComboBox
