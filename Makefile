...
# Generated by qmake (2.01a) (Qt 4.7.1) on: Mon Mar 14 12:35:06 2011
# Project:  Entomologist.pro
# Template: app
# Command: /usr/bin/qmake -spec /usr/share/qt4/mkspecs/linux-g++-64 -o Makefile Entomologist.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DAPP_VERSION=\"0.4\" -DQT_NO_DEBUG -DQT_SQL_LIB -DQT_XML_LIB -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
...
SOURCES       = main.cpp \
		...
		trackers/Mantis.cpp \
		ChangelogWindow.cpp \
		ChangelogListDelegate.cpp moc_MainWindow.cpp \
...
Makefile: Entomologist.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/g++.conf \
	...
	$(QMAKE) -spec /usr/share/qt4/mkspecs/linux-g++-64 -o Makefile Entomologist.pro
